...
class Ui_jarvisGui(object):
    def setupUi(self, jarvisGui):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("D:/Minor Project/JarvisGUI/Gifs/7LP8.gif"))
        ...
        self.label_2.setPixmap(QtGui.QPixmap("D:/Minor Project/JarvisGUI/Gifs/Jarvis_Loading_Screen.gif"))
